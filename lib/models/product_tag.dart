...
class ProductTag extends Equatable {
  ...
  factory ProductTag.fromJson(Map<String, dynamic> json) {
    return ProductTag(
      ...
      backgroundColor: hexToColor(json['backgroundColor'] as String),
      textColor: hexToColor(json['textColor'] as String),
      borderColor: hexToColor(json['borderColor'] as String),
